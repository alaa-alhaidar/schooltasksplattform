...
function App() {
  ...
  const fetchAssignments = async () => {
    ...
    // Ensure class_level is stored as a number
  ...
  const filteredAssignments = assignments.filter((assignment) => {
    ...
    const matchesClass =
      selectedClass === null || Number(assignment.class_level) === Number(selectedClass);
    ...
    <div className="flex min-h-screen bg-[#FAF7F7]">
        ...
        <div className="mt-auto">
          {user ? (
            <button
              ...
              className="p-3 text-gray-400 hover:text-white hover:bg-gradient-to-r hover:from-blue-200 hover:to-purple-400 rounded-xl"
            >
              <LogOut size={24} />
            </button>
          ) : (
      ...
      <main className="flex-1 p-8">
        <header className="flex justify-between items-center mb-12">
          <h1 className="text-5xl font-bold">my school tasks</h1>
                  ...
                  >
                    <div className="flex items-center space-x-2 mb-4">
                      ...
                      >
                        ...
                        {assignment.subject === "English" && <Book size={20} />}
                        {assignment.subject === "Physic" && <Atom size={20} />}
                        {assignment.subject === "Chemie" && <Beaker size={20} />}
                      </span>
